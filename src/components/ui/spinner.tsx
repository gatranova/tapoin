...
const Default = ({ className, ...props }: Omit<SpinnerProps, "variant">) => (
  <LoaderIcon className={cn("animate-spin", className)} {...props} />
);

const Circle = ({ className, ...props }: Omit<SpinnerProps, "variant">) => (
  <LoaderCircleIcon className={cn("animate-spin", className)} {...props} />
);

const Pinwheel = ({ className, ...props }: Omit<SpinnerProps, "variant">) => (
  <LoaderPinwheelIcon className={cn("animate-spin", className)} {...props} />
);

const CircleFilled = ({ className, size = 24, ...props }: Omit<SpinnerProps, "variant">) => (
...
const Ellipsis = ({ size = 24, ...props }: Omit<SpinnerProps, "variant">) => {
  return (
...
const Ring = ({ size = 24, ...props }: Omit<SpinnerProps, "variant">) => (
...
const Bars = ({ size = 24, ...props }: Omit<SpinnerProps, "variant">) => (
  <svg height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>Loading...</title>
    <style>{`
      .spinner-bar {
...
const Infinite = ({ size = 24, ...props }: Omit<SpinnerProps, "variant">) => (
